...
var __dsPreview = (() => {
  ...
  // .design-sync/previews/PollCard.tsx
  var PollCard_exports = {};
  __export(PollCard_exports, {
    Active: () => Active,
    Ended: () => Ended
  });
  init_define_import_meta_env();
  ...
  var Active = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    ds_exports.PollCard,
    {
  ...
  var Ended = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    ds_exports.PollCard,
    {
  ...
  return __toCommonJS(PollCard_exports);
})();
